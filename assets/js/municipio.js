...
function formValido(form) {
    ...
    form.querySelectorAll('input, select, textarea').forEach(function(el) {
        ...
        if (name === 'nombmunicipio' && !validarNombre(el)) ok = false;
...
document.addEventListener('DOMContentLoaded', function () {
    var forms = document.querySelectorAll('.form-municipio');
    forms.forEach(function(form) {
        var nombreInput = form.querySelector('input[name="nombmunicipio"]');
        if (nombreInput) {
        ...
        form.addEventListener('submit', function(e) {
            ...
            form.querySelectorAll('input, select, textarea').forEach(function(el) {
                var name = el.getAttribute('name');
                if (name === 'nombmunicipio' && !validarNombre(el)) valido = false;
